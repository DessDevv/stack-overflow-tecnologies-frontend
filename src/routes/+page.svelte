<script>
	...
	let selectedOption = 'All Respondents';
...
<nav class="nav-container">
  <a href="/" class="{selectedOption === 'All Respondents' ? 'seleccionado' : ''} nav-item-1">All Respondents</a>
  <a href="/professionaldev" class="{selectedOption === 'Professional Developers' ? 'seleccionado' : ''} nav-item-2">Professional Developers</a>
  <a href="/learningtocode" class="{selectedOption === 'Learning to Code' ? 'seleccionado' : ''} nav-item-3">Learning to Code</a>
  <a href="/othercoders" class="{selectedOption === 'Other Coders' ? 'seleccionado' : ''} nav-item-4">Other Coders</a>
</nav>
